...
def get_tcga(root,n_labeled,transform_train=None,transform_val=None):
    ...
    train_unlabeled_dataset = TCGA_unlabeled(base_dataset, train_unlabeled_idxs,  transform=TransformTwice(transform_train))
    transductive_dataset = TCGA_labeled(base_dataset, train_unlabeled_idxs,  transform=transform_val)
    ...
    return train_labeled_dataset, train_unlabeled_dataset, val_dataset,transductive_dataset

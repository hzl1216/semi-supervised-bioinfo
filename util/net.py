...
class Vae(nn.Module):
    def __init__(self, encode_length=100):
        super(Vae, self).__init__()
        self.fc11 = nn.Linear(11264, encode_length)
        self.fc12 = nn.Linear(11264, encode_length)
        self.fc2 = nn.Linear(encode_length, 1024)
        self.fc3 = nn.Linear(1024,10030)
    ...
    def encode(self, x):
        return self.fc11(F.relu(x)),self.fc12(F.relu(x))

...
#        vae_scheduler =  WarmupCosineSchedule(vae_optimizer,warmup_step,totals)
    else:
        scheduler = None
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        class_loss, cons_loss = train_semi(train_labeled_loader, train_unlabeled_loader, model, ema_model, vae, optimizer,ema_optimizer, vae_optimizer,epoch,scheduler)
